...
# Solution techniques are Dict with Key as key and value as Doubly Linked List node & Doubly Linked List to maintain LRU order of Nodes with LRU node at tail and most recently used node at head
